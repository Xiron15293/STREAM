...
void main() {
  ...
  test('restore with invalid ids falls back to tutti i conti for current profile',
      () async {
    SharedPreferences.setMockInitialValues({
  ...
  test('restore with null activeProfileId uses safe fallback and creates no bleed',
      () async {
    SharedPreferences.setMockInitialValues({
      'dashboard_net_worth_account_ids_profile_a': ['acc_a'],
    });
