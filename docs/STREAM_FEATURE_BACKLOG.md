...
**Da definire:** UI del selettore periodo in Archivio, integrazione con StreamDatePicker.
...
**Da definire:** UI del selettore periodo in Dashboard, impatto su hero card e KPI grid, persistenza del filtro.
...
| Campo | Valore |
|-------|--------|
| **Descrizione** | Export completo SQLite + SharedPreferences. Import/restore da file. Backup automatico periodico |
| **Motivazione** | L'utente deve poter salvare i dati prima di disinstallare o cambiare dispositivo |
| **Priorità** | Media |
| **Dipendenze** | F09 (date) |
| **Versione candidata** | V1.1 |
| **Stato** | ⏳ POST-MVP |
...
| **Feature completate** | 11 (F01–F11) |
| **Feature approvate** | 3 (F12–F13, F30) |
| **Feature in valutazione** | 6 (F14–F18, F32) |
| **Feature future** | 7 (F19–F24, F31) |
| **Feature post-MVP** | 5 (F25–F29) |
...
### 🥇 Priorità Alta (V0.5 — prossima sessione)

| Ordine | Feature | Impatto | Sforzo |
|--------|---------|---------|--------|
| 1 | F14 — Calendario Tab | Alto | Medio |
| 2 | F15 — Archivio Filtrato | Alto | Medio |
| 3 | F16 — Dashboard Filtrata | Alto | Medio |
| 4 | F12 — V0.4.3 UX Rapidi/Preferiti | Alto | Basso-Medio |
| 5 | F30 — Inline Form Validation | Medio | Basso |

### 🥈 Priorità Media (V0.6–V0.7)

| Ordine | Feature | Impatto | Sforzo |
|--------|---------|---------|--------|
| 6 | F13 — Calendar Heatmap | Medio | Basso (dipende da F14) |
| 7 | F23 — Ricerca Globale | Alto | Basso |
| 8 | F17 — Category Sorting | Medio | Basso |
| 9 | F19 — Ricorrenze | Alto | Alto |
| 10 | F20 — Athena Foundation | Alto | Alto |

### 🥉 Priorità Bassa (V0.8–V1.0)

| Ordine | Feature | Impatto | Sforzo |
|--------|---------|---------|--------|
| 11 | F21 — Import CSV | Alto | Alto |
| 12 | F22 — Scenari | Medio | Alto |
| 13 | F24 — Refactor Grafico Categorie | Basso | Basso |
| 14 | F30 — Inline Form Validation | Medio | Basso |
| 15 | F28 — Error Feedback | Medio | Basso |
| 16 | F29 / F31 — Layout Tablet | Basso | Alto |
...
V0.4.2 ✅
  ...
  ├── V0.5.1 (F09) ✅ → V0.5.2 (F10) ✅ → V0.5.3 (F11) ✅
  │     └── V0.5.4 (F14) ─┬── V0.5.5 (F15)
  │                        └── V0.5.6 (F16)
  ├── F13 (Heatmap) ← F14 + F11
  ├── F19 (Ricorrenze) ← F14
  ├── F20 (Athena) ← F16
