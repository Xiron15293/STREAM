...
const _fallbackChartPalette = StreamChartPalette(
  ...
  cardBackground: Color(0xFF15171D),
  cardBorderColor: Color(0xFF1E2028),
  cardBorderWidth: 1,
  cardRadius: 16,
  cardShadows: [],
  emptyStateIconColor: Color(0xFF636366),
  emptyStateTextColor: Color(0xFF8E8E93),
  legendAccentColor: Color(0xFF8E8E93),
  horizontalTrackColor: Color(0xCC1E2028),
