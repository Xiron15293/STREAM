          ...
          for (final entry in labelPositions)
            Container(
              ...
              child: Text(
                ...
                key: Key('annual_heatmap_month_label_${monthChanges[entry.key]}'),
    ...
    return Row(
      children: [
        ...
        for (int col = 0; col < weeks.length; col++) ...[
          ...
          _buildCell(weeks[col][dow], cellWidth, cellHeight, daysInYear, todayDate),
        ],
      ],
    );
  }
...
class _AnnualNavGlyph extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Icon(icon, color: StreamColors.textSecondary),
    );
  }
}
